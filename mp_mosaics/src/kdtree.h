...
class KDTree
{
  ...
  public:
    ...
    KDTreeNode* copyTree(const KDTreeNode* subroot);
     ...
     */
    void delTree(KDTreeNode* treeRoot);
    ~KDTree();
...
KDTreeNode* Helper(KDTreeNode* currNode, const Point<Dim>& target, KDTreeNode* currBest, int currDim) const;
